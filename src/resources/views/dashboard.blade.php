                        ...
                        <div class="col-md-4 col-xl-3">
                            <div class="card bg-c-blue order-card">
                                <div class="card-block">
                                    ...
                                    <h2 class="text-right"><i class="fa fa-cart-plus f-left"></i>&nbsp;&nbsp;<span>{{ $totalJobsPosted }}</span></h2>
                                    <p class="m-b-0">Your jobs<span class="f-right">{{ $totalJobsPosted }}</span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-xl-3">
                            <div class="card bg-c-yellow order-card">
                                <div class="card-block">
                                    ...
                                    <h2 class="text-right"><i class="fa fa-refresh f-left"></i><span>€{{$amount}}</span></h2>
                                    <p class="m-b-0">{{$plan}}<span class="f-right"></span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-xl-3">
                            <div class="card bg-c-pink order-card">
                                <div class="card-block">
                                    ...
                                    <h2 class="text-right"><i class="fa fa-credit-card f-left"></i><span>{{ $totalApplicants }}</span></h2>
                                    <p class="m-b-0">Your applicants<span class="f-right">{{ $totalApplicants }}</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
