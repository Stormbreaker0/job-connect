...
<div class="container my-5">
    <div class="row align-items-center">
        <div class="col-md-6">
            <p class="text-center">
                ...
                Welcome to Job-Connect! We are dedicated to connecting job seekers with their dream jobs and helping employers find the perfect candidates. 
                Our platform offers a wide range of job listings across various industries and locations. 
                Our mission is to make the job search process as smooth and efficient as possible for everyone involved.
            </p>
        </div>
        <div class="col-md-6">
            <img src="{{ asset('image/connect.jpg') }}" alt="Job-Connect" class="img-fluid rounded" width="500">
        </div>
    </div>
    ...
    <p>You can email us at <a href="mailto:support@joblinker.com">support@jobconnect.com</a></p>
